...
$CONF['postfix_admin_url'] = 'http://mail.domain.tld/postfixadmin';
...
// prevent the web-server from executing external scripts.
// Parameters: (1) domain
// $CONF['domain_postcreation_script']='sudo -u vmail /usr/local/bin/postfixadmin-domain-postcreation.sh';
